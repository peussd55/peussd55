...
| 저장소 | 요약 |
|---|---|
| [**AI‑Study**](https://github.com/peussd55/AI-Study) | 인공지능 전반을 체계적으로 학습하기 위해 진행한 실습 코드와 예제를 모아 둔 포트폴리오입니다. Python 기초부터 데이터 전처리, 전통 머신러닝, TensorFlow·PyTorch 딥러닝 실습, FastAPI와 Streamlit을 이용한 LLM 서비스까지 폭넓은 주제가 포함되어 있습니다. |
